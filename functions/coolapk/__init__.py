...
@channel.use(ListenerSchema(listening_events=[GroupMessage],inline_dispatchers=[Kanata([FullMatch("酷安酷图")])]))
async def coolapk(
    ...
    n = await request("https://api.coolapk.com/v6/page/dataList?url=%2Ffeed%2FcoolPictureList%3FfragmentTemplate%3Dflex&title=&subTitle=&page=1")
